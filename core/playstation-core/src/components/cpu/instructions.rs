        ...
        match instruction.primary() {
            0x00 => {
                match instruction.secondary() {
                    0x00 => self.sll(instruction),
                    0x02 => self.srl(instruction),
                    0x03 => self.sra(instruction),
                    0x04 => self.sllv(instruction),
                    0x06 => self.srlv(instruction),
                    0x07 => self.srav(instruction),
                    0x08 => self.jr(instruction),
                    0x09 => self.jalr(instruction),
                    0x0C => self.syscall(instruction)?,
                    0x0D => self.r#break(instruction)?,
                    0x10 => self.mfhi(instruction),
                    0x11 => self.mthi(instruction),
                    0x12 => self.mflo(instruction),
                    0x13 => self.mtlo(instruction),
                    0x18 => self.mult(instruction),
                    0x19 => self.multu(instruction),
                    0x1A => self.div(instruction),
                    0x1B => self.divu(instruction),
                    0x20 => self.add(instruction)?,
                    0x21 => self.addu(instruction),
                    0x22 => self.sub(instruction)?,
                    0x23 => self.subu(instruction),
                    0x24 => self.and(instruction),
                    0x25 => self.or(instruction),
                    0x26 => self.xor(instruction),
                    0x27 => self.nor(instruction),
                    0x2A => self.slt(instruction),
                    0x2B => self.sltu(instruction),
